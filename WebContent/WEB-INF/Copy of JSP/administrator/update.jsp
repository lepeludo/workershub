...
<h1> Update page for ${worker.firstName}</h1>
<h2>change your profile</h2>
<c:url value="doupdate" var="updateurl" />
	<sf:form action="${updateurl}" method="post" commandName="updateWorkerForm">	
		...
		<c:forEach items="${updateWorkerForm.phoneNumbers}" varStatus="status">

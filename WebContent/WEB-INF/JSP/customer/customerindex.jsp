...
<div class="col-md-3 column margintop20">
  ...
  <li><a href="${pageContext.request.contextPath}/jobs/search"><span class="glyphicon glyphicon-chevron-right"></span> Lookup a worker</a></li>
  <li><a href="${pageContext.request.contextPath}/customer/profile"><span class="glyphicon glyphicon-chevron-right"></span> My Profile</a></li>

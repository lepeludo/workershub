...
<a href="${pageContext.request.contextPath}/administrator/searchworkerslocationtype">Worker search</a>
<a href="${pageContext.request.contextPath}/administrator/reviews">Read reported reviews</a>
<a href="${pageContext.request.contextPath}/administrator/addlocationsandjobtypes">Add locations and jobtypes</a>
</body>
</html>